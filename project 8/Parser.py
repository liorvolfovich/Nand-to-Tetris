...
class Parser:
    ...
    def command_type(self) -> str:
        ...
        if self.current_instruction in self.arithmetic_set:
            ...
            return "C_POP"
        elif "label" in self.current_instruction:
            return "C_LABEL"
        elif "function" in self.current_instruction:
            return "C_FUNCTION"
        elif "return" in self.current_instruction:
            return "C_RETURN"
        elif "call" in self.current_instruction:
            return "C_CALL"
        else:
            no_spaces_command = self.current_instruction.replace(" ", "").replace("\t", "")
            if "if-goto" in no_spaces_command:
                return "C_IF"
            elif "goto" in no_spaces_command:
                return "C_GOTO"
